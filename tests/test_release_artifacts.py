...
FIXTURE_GUI_FILES = {
    ...
    "gui/package.json": b'{"name":"codex-keysmith-gui","version":"0.3.5"}\n',
...
def test_repository_version_metadata_is_release_state_neutral():
    ...
    assert "## [{}] - 2026-08-15".format(VERSION) in changelog
    assert "Source version v0.3.5" in readme
    assert "v0.3.5 local candidate" not in readme
