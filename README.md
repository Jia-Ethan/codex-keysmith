...
<p align="center">
  ...
  <img alt="Source version v0.3.1" src="https://img.shields.io/badge/source-v0.3.1-0099CC">
...
- 当前统一源码版本为 `0.3.1`；正式 `v0.3.1` Release 提供单文件 CLI 与包含首批场景包的确定性源码归档。[`desktop-v0.2.0-beta.6`](https://github.com/Jia-Ethan/codex-keysmith/releases/tag/desktop-v0.2.0-beta.6) 仍是当前 macOS Apple Silicon DMG 与 Windows x64 NSIS 预发布版本，不包含本次场景库更新。
