...
`desktop-v0.2.0-beta.1` is a public GitHub Pre-release for the Windows x64 desktop client. It is **Beta / unsigned / native-CI-validated** and is not the formal signed `v0.2.0` release.
